$(document)['ready'](function() {
    var _0xe93dx1 = ['table', 'heading', 'row', 'col', 'youtube', 'num', 'accordion', 'content', 'item', 'quote', 'alert', 'success', 'warning', 'update', 'info', 'tab'];
    $('.post')['each'](function() {
    ...
    $('.sc-youtube')['each'](function() {
        ...
        var _0xe93dx2 = '<iframe width="900" height="630" name="[DhtmlXQ]' + _0xe93dx40 + '[DhtmlXQ_zoom]1.80.500[/DhtmlXQ_zoom][/DhtmlXQ]" src="https://rawgit.com/n280681/cotuong/master/XQBase.htm" scrolling="no" frameborder="0" ></iframe>';
        $(this)['replaceWith'](_0xe93dx2);
    });
$(document)['ready'](function() {
    $('.sc-top')['hide']();
