...
function initboard()
{
	...
	s+=cDIV(6,1,w3-7,'',0,typ,'','Comment:<a href="javascript:TXTtoDhtmlXQ(cText)" title="Add Variation">AddVar</a> <a href="javascript:EditComment(cText)" title="Edit Comment" id="e_comm">\EditCom</a>');
	...
	s+=('</div>');
	s+=cDIV(6,thh+ch+1,w3-7,'',0,typ,'','Variation:\u2000   <a href="javascript:UpMove()" title="Move up variation">Up</a>\u2000<a href="javascript:DownMove()" title="Move down variation">Dn</a>\u2000<a href="javascript:DelMove()" title="Delete variation">Del</a>');
